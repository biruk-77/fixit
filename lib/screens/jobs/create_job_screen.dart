...
class _CreateJobScreenState extends State<CreateJobScreen>
  ...
  Future<void> _createJob() async {
    ...
    try {
      ...
      // Notify the posting user (client)
      ...
      // Notify all workers matching profession (not location)
      ...
      print('Found \'${workersQuery.docs.length}\' workers with profession: \'$_selectedCategory\'.');
      int notifiedCount = 0;
      for (final doc in workersQuery.docs) {
        await _firebaseService.createNotification(
          userId: doc.id,
          title: "New Job Posted",
          body: "A new job '${_titleController.text.trim()}' matching your skills is available!",
          type: "job_posted",
          data: {
            'jobId': jobId,
            'title': _titleController.text.trim(),
